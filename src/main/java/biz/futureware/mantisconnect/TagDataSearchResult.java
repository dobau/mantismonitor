...
public class TagDataSearchResult  implements java.io.Serializable {
    private biz.futureware.mantisconnect.TagData[] results;
    ...
    public TagDataSearchResult(
           biz.futureware.mantisconnect.TagData[] results,
     ...
     * @return results
     */
    public biz.futureware.mantisconnect.TagData[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(biz.futureware.mantisconnect.TagData[] results) {
        this.results = results;
    }
