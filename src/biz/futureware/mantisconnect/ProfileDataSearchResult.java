...
public class ProfileDataSearchResult  implements java.io.Serializable {
    private biz.futureware.mantisconnect.ProfileData[] results;
    ...
    public ProfileDataSearchResult(
           biz.futureware.mantisconnect.ProfileData[] results,
     ...
     * @return results
     */
    public biz.futureware.mantisconnect.ProfileData[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(biz.futureware.mantisconnect.ProfileData[] results) {
        this.results = results;
    }
