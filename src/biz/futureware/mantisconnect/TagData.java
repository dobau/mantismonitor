...
public class TagData  implements java.io.Serializable {
    ...
    private biz.futureware.mantisconnect.AccountData user_id;
    ...
    public TagData(
           ...
           biz.futureware.mantisconnect.AccountData user_id,
     ...
     * @return user_id
     */
    public biz.futureware.mantisconnect.AccountData getUser_id() {
        return user_id;
    }
     ...
     * @param user_id
     */
    public void setUser_id(biz.futureware.mantisconnect.AccountData user_id) {
        this.user_id = user_id;
    }
