...
public class IssueData  implements java.io.Serializable {
    ...
    private biz.futureware.mantisconnect.AccountData[] monitors;

    private java.lang.Boolean sticky;

    private biz.futureware.mantisconnect.ObjectRef[] tags;
    ...
    public IssueData(
           ...
           biz.futureware.mantisconnect.AccountData[] monitors,
           java.lang.Boolean sticky,
           biz.futureware.mantisconnect.ObjectRef[] tags) {
           this.id = id;
     ...
     * @return monitors
     */
    public biz.futureware.mantisconnect.AccountData[] getMonitors() {
        return monitors;
    }
     ...
     * @param monitors
     */
    public void setMonitors(biz.futureware.mantisconnect.AccountData[] monitors) {
        this.monitors = monitors;
    }
     ...
     * @return tags
     */
    public biz.futureware.mantisconnect.ObjectRef[] getTags() {
        return tags;
    }
     ...
     * @param tags
     */
    public void setTags(biz.futureware.mantisconnect.ObjectRef[] tags) {
        this.tags = tags;
    }
